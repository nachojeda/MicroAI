...
@app.post("/forum/list/users/pending")
def list_pending_users():
    return pending_users

@app.delete("/forum/delete/users/pending")
...
@app.post("/forum/login/validate", response_model=ValidUser)
...
@app.get("/forum/list/users/valid")
...
# should be above /forum/login/{username}/{password}
@app.get("/forum/login/details/info")
def login_info():
    return {"message": "username and password are needed"}

# should be above /forum/login/{username}/{password}
@app.get("/forum/login/password/change")
...
# should be above /forum/login/{username}/{password}
@app.post("/forum/login/username/unlock")
...
# should be above /forum/login/{username}/{password}
@app.post("/forum/login/password/unlock")
...
@app.get("/forum/login/{username}/{password}")
...
@app.post("/forum/account/profile/add", response_model=UserProfile)
...
@app.put("/forum/account/profile/update/{username}")
...
@app.patch("/forum/account/profile/update/names/{username}")
...
@app.get("/forum/account/profile/view/{username}")
...
@app.post("/forum/discussion/posts/add/{username}")
...
@app.post("/forum/discussion/posts/reply/{username}")
...
@app.put("/forum/discussion/posts/update/{username}")
...
@app.delete("/forum/discussion/posts/remove/{username}")
...
@app.get("/forum/discussion/posts/view/{username}")
...
@app.post("/forum/login/rememberme/create/")
